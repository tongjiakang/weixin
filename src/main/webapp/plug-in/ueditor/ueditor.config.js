...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        //,imagePath:'http://localhost/weixinPic/'                     图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
        ,imagePath:'https://221.224.53.27/weixinPic/'                     //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
        ...
        ,videoPath:'https://221.224.53.27/weixinFile/'                   //附件修正地址，同imagePath
        //,videoFieldName:"upfile"                    //附件提交的表单名，若此处修改，需要在后台对应文件修改对应参数

        //工具栏上的所有的功能按钮和下拉框，可以在new编辑器的实例时选择自己需要的从新定义
        , toolbars:[["bold","italic","underline","|","insertorderedlist","insertunorderedlist","|","insertimage","|",'removeformat','forecolor','backcolor',"fullscreen"]]
        /* 
