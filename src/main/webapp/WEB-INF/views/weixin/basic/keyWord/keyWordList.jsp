...
<script type="text/javascript">
	...
	function deleteFun(id) {
		parent.$.messager.confirm('询问', '您是否要删除关键字？', function(b) {
			if (b) {
				progressLoad();
				$.post('${ctx}/keyWord/delete', {
					id : id
				}, function(result) {
					if (result.success) {
	...
	function addFun() {
		parent.$.modalDialog({
			...
			width : 500,
			height : 320,
			href : '${ctx}/keyWord/addPage',
			buttons : [ {
				text : '保存',
				handler : function() {
					parent.$.modalDialog.openner_dataGrid = dataGrid;
					var f = parent.$.modalDialog.handler.find('#keyWordAddForm');
					f.submit();
				}
			}, {
				text : '取消',
		...
		<form id="searchForm">
			<table class="tabContent0">
				<tr>
					...
					<th width="10%" align="right">关键字:</th>
					<td width="20%" align="left">
