...
<script type="text/javascript">
	$('#welcomesAddForm').form({
		url : '${ctx}/welcomes/save',
		onSubmit : function() {
			progressLoad();
...
<div class="easyui-layout" data-options="fit:true,border:false">
	<div data-options="region:'center',border:false" title=""
		...
		<form id="welcomesAddForm" method="post">
			<table class="grid">
				<tr>
					<td>公众号:</td>
					<td><input id="accountId" name="accountId" type="text" data-options="editable:false,panelHeight:'auto',required:true"/></td>
				</tr>
				<tr>
					<td>消息类型:</td>
