...
<script type="text/javascript">
	...
	function editFun(id) {
		parent.$.modalDialog({
			...
			width : 500,
			height : 320,
			href : '${ctx}/unKnowWord/editPage?id=' + id,
			buttons : [ {
				text : '保存',
				handler : function() {
					parent.$.modalDialog.openner_dataGrid = dataGrid;//因为添加成功之后，需要刷新这个dataGrid，所以先预定义好
					var f = parent.$.modalDialog.handler.find('#unKnowWordEditForm');
					f.submit();
				}
			}, {
				text : '取消',
	...
	function addFun() {
		parent.$.modalDialog({
			...
			width : 500,
			height : 320,
			href : '${ctx}/unKnowWord/addPage',
			buttons : [ {
				text : '保存',
				handler : function() {
					parent.$.modalDialog.openner_dataGrid = dataGrid;
					var f = parent.$.modalDialog.handler.find('#unKnowWordAddForm');
					f.submit();
				}
			}, {
				text : '取消',
